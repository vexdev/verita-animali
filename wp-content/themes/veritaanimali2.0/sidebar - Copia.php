<div id="sidebar">
  <ul id="pagenav">
   <?php  login_with_ajax(); ?><?php
	...
	// determino il padre più anziano (super-padre) della pagina
	...
	// stampo la struttura facendo in modo che venga espanso il ramo sul quale è posizionata la pagina corrente
